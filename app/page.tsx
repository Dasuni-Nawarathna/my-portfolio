        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="flex-1 w-full">
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://github.com/Dasuni-Nawarathna" target="_blank" className="flex items-center gap-4 py-2 group hover:opacity-100 opacity-90 transition">
              ...
              <li>
                <a href="https://www.linkedin.com/in/dasuni-nawarathna-7243372b2/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3BH4%2F3M3hdS5KdKpqrc0oXZw%3D%3D" target="_blank" className="flex items-center gap-4 py-2 group hover:opacity-100 opacity-90 transition">
